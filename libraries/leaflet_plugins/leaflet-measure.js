...
var controlTemplate = _.template("<a class=\"<%= model.className %>-toggle js-toggle\" href=\"#\" title=\"Mesure de distances et surfaces\">Measure</a>\n<div class=\"<%= model.className %>-interaction js-interaction\">\n  <div class=\"js-startprompt startprompt\">\n    <h3>Mesure de distances et surfaces</h3>\n    <ul class=\"tasks\">\n      <a href=\"#\" class=\"js-start start\">Commencer une mesure</a>\n    </ul>\n  </div>\n  <div class=\"js-measuringprompt\">\n    <h3>Mesure de distances et surfaces</h3>\n    <p class=\"js-starthelp\">Commencer votre mesure en ajoutant des points sur la carte</h3>\n    <div class=\"js-results results\"></div>\n    <ul class=\"js-measuretasks tasks\">\n      <li><a href=\"#\" class=\"js-cancel cancel\">Annuler</a></li>\n      <li><a href=\"#\" class=\"js-finish finish\">Terminer la mesure</a></li>\n    </ul>\n  </div>\n</div>");
var resultsTemplate = _.template("<div class=\"group\">\n<p class=\"lastpoint heading\">Dernier point</p>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n</div>\n<% if (model.pointCount > 1) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Distance</span> <%= humanize.numberFormat(model.length.meters, 0, ',', '.') %> Mètres (<%= humanize.numberFormat(model.length.kilometers, 2, ',', '.') %> Kms)</p>\n</div>\n<% } %>\n<% if (model.pointCount > 2) { %>\n<div class=\"group\">\n<p><span class=\"heading\">Surface</span> <%= humanize.numberFormat(model.area.sqmeters, 2, ',', '.') %> m² (<%= humanize.numberFormat(model.area.hectares, 2, ',', '.') %> Ha)</p>\n</div>\n<% } %>");
var pointPopupTemplate = _.template("<h3>Point Location</h3>\n<p><%= model.lastCoord.dms.y %> <span class=\"coorddivider\">/</span> <%= model.lastCoord.dms.x %></p>\n<p><%= humanize.numberFormat(model.lastCoord.dd.y, 6) %> <span class=\"coorddivider\">/</span> <%= humanize.numberFormat(model.lastCoord.dd.x, 6) %></p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrer la carte sur ce point</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Delete</a></li>\n</ul>");
var linePopupTemplate = _.template("<h3>Linear Measurement</h3>\n<p><%= humanize.numberFormat(model.length.meters, 0, ',', '.') %> Mètres</p>\n<p><%= humanize.numberFormat(model.length.meters, 2 ,',', '.') %> Mètres</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrer la carte sur cette ligne</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Supprimer</a></li>\n</ul>");
var areaPopupTemplate = _.template("<h3><strong>Résultats des mesures</strong></h3>\n<p><strong>Surface: </strong><%= humanize.numberFormat(model.area.sqmeters, 2, ',', '.') %> m² (<%= humanize.numberFormat(model.area.hectares, 2, ',', '.') %> Ha)</p>\n<p><strong>Périmètre:</strong> <%= humanize.numberFormat(model.length.meters, 0, ',', '.') %> Mètres (<%= humanize.numberFormat(model.length.meters, 2, ',', '.') %> Mètres)</p>\n<ul class=\"tasks\">\n  <li><a href=\"#\" class=\"js-zoomto zoomto\">Centrer la carte sur cette surface</a></li>\n  <li><a href=\"#\" class=\"js-deletemarkup deletemarkup\">Supprimer</a></li>\n</ul>");
